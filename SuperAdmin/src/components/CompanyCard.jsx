...
const CompanyCard = ({ name, plan, storageUsed, docsUploaded, clients, employees, membershipDays }) => {
  return (
    <div className="border border-black rounded-md p-4 space-y-2 bg-white shadow-sm">
      <div className="font-semibold text-base">{name} - {plan}</div>
